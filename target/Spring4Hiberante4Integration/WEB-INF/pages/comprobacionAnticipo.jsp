		...
		<div id="page-wrapper">
           ...
           <div style="border-color: #e7e7e7;" class="panel panel-default">
					...
					<div style="height: 54px" class="panel-heading">
						  ...
						  <!-- Esto es para aparecer el boton solo si hay un id de comprobacion activo.  --> 			
						<!--  <c:if test="${comprobacionAnticipoDTO.idSolicitudComprobacionSession > 0}"> --> 	
						  <button id="btnDeposito" onclick="" style="margin-left: 10px; float: right;" type="button" class="btn btn-default"
						  data-toggle="modal" data-target="#deposito"><%=etiqueta.DEPOSITO%></button>
						 <!-- </c:if> --> 	
					</div>
					<div class="panel-body">
								...
								<tbody>
									<c:forEach items="${comprobacionAnticipoDTO.lstFactDto}"
										...
										<tr id="${status.index}">
											...
											<td><form:input cssClass="form-control sbts currencyFormat"
